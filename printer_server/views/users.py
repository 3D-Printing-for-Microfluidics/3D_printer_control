...
def generate_user_table_column_definition():
    ...
    columns = [
        ...
        Column(key="col-print-permissions", name="Print Permissions", value=lambda r: r.print_permissions, type="checkbox", href_enabled=is_auth and is_admin, button_class="user-table-permission-btn", visible=True, db_col=User.print_permissions, db_filter=generate_boolean_lambda(User.print_permissions), vertical_header=True),
        Column(key="col-calibration-permissions", name="Calibration Permissions", value=lambda r: r.calibration_permissions, type="checkbox", href_enabled=is_auth and is_admin, button_class="user-table-permission-btn", visible=True, db_col=User.calibration_permissions, db_filter=generate_boolean_lambda(User.calibration_permissions), vertical_header=True),
        Column(key="col-advanced-permissions", name="Advanced Permissions", value=lambda r: r.advanced_permissions, type="checkbox", href_enabled=is_auth and is_admin, button_class="user-table-permission-btn", visible=True, db_col=User.advanced_permissions, db_filter=generate_boolean_lambda(User.advanced_permissions), vertical_header=True),
        Column(key="col-admin-permissions", name="Admin Permissions", value=lambda r: r.admin_permissions, type="checkbox", href_enabled=lambda r: is_auth and is_admin and r.username not in ["admin", "default"], button_class="user-table-permission-btn", visible=True, db_col=User.admin_permissions, db_filter=generate_boolean_lambda(User.admin_permissions), vertical_header=True),
        Column(key="col-reset", name="Edit User", type="button", href_enabled=lambda r: is_auth and (r.id == user_id or is_admin) and r.username not in ["admin", "default"], button_style="btn-outline-warning", button_name="Edit", button_class="user-table-reset-btn", sortable=False, filterable="No", visible=True),
        Column(key="col-delete", name="Delete User", type="button", href_enabled=lambda r: is_auth and (r.id == user_id or is_admin) and r.username not in ["admin", "default"], button_style="btn-outline-danger", button_name="Delete", button_class="user-table-delete-btn", sortable=False, filterable="No", visible=True)
    ]
