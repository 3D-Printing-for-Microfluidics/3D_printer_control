...
const float TIP_CORRECTION_FACTOR = 1.429; //tip was only moving 70% of distance
...
const int FAST_SPEED = 3000; //fast homing speed
const int MEDIUM_SPEED = 2000; //medium homing speed
const int SLOW_SPEED = 500; //slow homing speed
...
Tip_Tilt::Tip_Tilt(){
    ...
    //create axis
    tipAxis = new Axis("Tip", true, TIP_DIR_PIN, TIP_STEP_PIN, TIP_EN, TIP_ENCODER_I_PIN, 
