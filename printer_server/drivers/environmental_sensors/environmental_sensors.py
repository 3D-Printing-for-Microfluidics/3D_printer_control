...
class EnvironmentalSensors(USBSerial):
    ...
    def __init__(self, config_dict=None, log_level=logging.DEBUG):
        ...
        super().__init__("Environmental Sensors", vid=config_dict["vendor_id"], pid=config_dict["product_id"], sn=config_dict["serial_number"],  baudrate=config_dict["baudrate"], timeout=1, line_ending='\n', logger=self.log)
